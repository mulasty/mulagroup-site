...
function ServiceCard({
  ...
  return (
    <div
      className={`group relative flex flex-col items-center rounded-2xl border border-slate-200/80 bg-slate-100/60 p-8 backdrop-blur-xl transition-all duration-700 hover:border-cyan-400/30 hover:bg-slate-100/80 hover:-translate-y-1.5 hover:shadow-[0_0_40px_-10px_rgba(6,182,212,0.12)] dark:border-white/[0.05] dark:bg-white/[0.02] dark:hover:border-cyan-400/20 dark:hover:bg-white/[0.03] ${
    ...
    >
      ...
      <div className="mb-6 h-24 w-24 text-slate-400 transition-colors duration-500 group-hover:text-cyan-400 dark:text-slate-500 dark:group-hover:text-cyan-400">
        <ServiceIllustration name={icon} />
      </div>

      <h3 className="mb-2.5 text-center text-base font-semibold tracking-tight text-slate-900 dark:text-white">
        {title}
      </h3>
    ...
    <section id="services" aria-labelledby="services-heading" className="relative py-28 sm:py-36">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <h2 id="services-heading" className="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-[2.5rem]">
            Kompetencje
          </h2>

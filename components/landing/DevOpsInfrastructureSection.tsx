      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-24 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {devOpsFeatures.map((card) => (
            <div
              key={card.title}
              className="group relative flex flex-col rounded-2xl border border-white/[0.08] bg-white/[0.04] p-7 backdrop-blur-xl transition-all duration-500 hover:border-white/[0.14] hover:bg-white/[0.06] hover:-translate-y-0.5 dark:border-white/[0.05] dark:bg-white/[0.02] dark:hover:border-white/[0.10] dark:hover:bg-white/[0.03]"
            >
              ...
              <div className="mb-5 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-white/[0.06] text-slate-300 ring-1 ring-white/[0.10] transition-all duration-500 group-hover:text-cyan-400 group-hover:ring-cyan-400/15 dark:bg-white/[0.03] dark:text-slate-400 dark:ring-white/[0.06]">

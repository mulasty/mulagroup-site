...
export default function EngagementModelsSection() {
  return (
    <section id="engagement" aria-labelledby="engagement-heading" className="relative py-28 sm:py-36">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 id="engagement-heading" className="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-[2.5rem]">Modele współpracy</h2>

      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-24 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {whyCards.map((card) => (
            <div
              key={card.title}
              className="group relative flex flex-col rounded-2xl border border-white/[0.08] bg-white/[0.05] p-8 backdrop-blur-xl transition-all duration-500 hover:border-white/[0.14] hover:bg-white/[0.07] hover:-translate-y-0.5"
            >
              ...
              <div className="mb-6 inline-flex h-10 w-10 items-center justify-center rounded-lg bg-white/[0.06] text-slate-300 ring-1 ring-white/[0.10] transition-all duration-500 group-hover:text-cyan-400 group-hover:ring-cyan-400/15">
        ...
        <div className="mt-24 grid gap-4 lg:grid-cols-2">
          {/* Generic agency */}
          <div className="rounded-2xl border border-white/[0.08] bg-white/[0.04] p-10 backdrop-blur-xl">
            ...
            <ul className="space-y-5">
              {comparisonGeneric.map((item) => (
                <li key={item} className="flex items-start gap-3 text-sm text-slate-500">
                  <span className="mt-0.5 inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-white/[0.04] text-slate-500 ring-1 ring-white/[0.08]">
          ...
          {/* Mula Group */}
          <div className="relative rounded-2xl border border-white/[0.08] bg-white/[0.05] p-10 backdrop-blur-xl">

...
function CheckItem({ children, accent }: { children: React.ReactNode; accent: "emerald" | "cyan" }) {
  ...
  return (
    <li className="flex items-start gap-3.5 text-sm text-slate-500 dark:text-slate-400">
...
export default function SecurityOperationsSection() {
  return (
    <section id="security" aria-labelledby="security-heading" className="relative overflow-hidden py-28 sm:py-36">
      {/* Top separator */}
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <h2 id="security-heading" className="text-3xl font-semibold tracking-tight text-slate-900 dark:text-white sm:text-4xl lg:text-[2.5rem]">
        ...
        <div className="mt-24 grid gap-5 lg:grid-cols-2">
          ...
          <div className="relative flex flex-col rounded-2xl border border-slate-200/80 bg-slate-100/60 p-10 backdrop-blur-xl dark:border-white/[0.05] dark:bg-white/[0.02]">
            ...
            <h3 className="mb-3 text-xl font-semibold tracking-tight text-slate-900 dark:text-white">Audyt bezpieczeństwa</h3>
            <p className="mb-12 text-base leading-relaxed text-slate-500 dark:text-slate-500">
          ...
          <div className="relative flex flex-col rounded-2xl border border-slate-200/80 bg-slate-100/60 p-10 backdrop-blur-xl dark:border-white/[0.05] dark:bg-white/[0.02]">
            ...
            <h3 className="mb-3 text-xl font-semibold tracking-tight text-slate-900 dark:text-white">Blue Teaming</h3>
            <p className="mb-12 text-base leading-relaxed text-slate-500 dark:text-slate-500">
